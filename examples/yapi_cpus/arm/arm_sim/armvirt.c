...
ARMul_LoadHalfWord (ARMul_State * state, ARMword address)
{
  ...
  if (do_trace > 1)
    fprintf (trace_file, "MEM %x\n", address);
  //fprintf(trace_file, "load_halfword\n\n");
...
ARMul_StoreWordS (ARMul_State * state, ARMword address, ARMword data)
{
  if (do_trace > 1)
    fprintf (trace_file, "MEM %x\n", address);
  //fprintf(trace_file, "store_wordS\n\n");
...
ARMul_StoreWordN (ARMul_State * state, ARMword address, ARMword data)
{
  ...
  if (do_trace > 1)
    fprintf (trace_file, "MEM %x\n", address);
  //fprintf(trace_file, "store_wordN\n\n");
...
ARMul_StoreHalfWord (ARMul_State * state, ARMword address, ARMword data)
{
  ...
  if (do_trace > 1)
    fprintf (trace_file, "MEM %x\n", address);
  //fprintf(trace_file, "store_halfword\n\n");
...
ARMul_WriteByte (ARMul_State * state, ARMword address, ARMword data)
{
  ...
  PutWord (state, address,
           (temp & ~(0xffL << offset)) | ((data & 0xffL) << offset), TRUE);
}
...
ARMul_SafeWriteByte (ARMul_State * state, ARMword address, ARMword data)
{
  ...
  PutWord (state, address,
           (temp & ~(0xffL << offset)) | ((data & 0xffL) << offset), FALSE);
}
