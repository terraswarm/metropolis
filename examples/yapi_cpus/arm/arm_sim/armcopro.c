...
void
write_cp15_reg (ARMul_State * state, unsigned reg, unsigned opcode_2,
        unsigned CRm, ARMword value)
{
    if (opcode_2)
        {
            switch (reg)
...
void write_cp14_reg (unsigned, ARMword);
ARMword read_cp14_reg (unsigned);
