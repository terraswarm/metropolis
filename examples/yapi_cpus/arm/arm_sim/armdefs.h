...
#define ARMul_CP15_R5_MMU_EXCPT        0x0200
...
extern void XScale_check_memacc (ARMul_State * state, ARMword * address,
                                 int store);
extern void XScale_set_fsr_far (ARMul_State * state, ARMword fsr,
                                ARMword far);
...
/* Trace exit condition variables */
extern int prev_pc;
extern int prev_inst_count;
#define REPEAT_INST_LIMIT 4        /* # duplicate instructions before exiting */
/*** End: Added by TCM ***/
