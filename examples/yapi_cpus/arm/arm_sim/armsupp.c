...
void
/* TCM modification for g++ compilation*/
ARMul_UndefInstr (ARMul_State * state, ARMword instr ATTRIBUTE_UNUSED)
//ARMul_UndefInstr (ARMul_State * state, ARMword)
{
  ARMul_Abort (state, ARMul_UndefinedInstrV);
}
...
ARMul_Align (state, address, data)
     ...
     ARMword data;
/* // C++ style
ARMul_Align (ARMul_State*,  ARMword address,  ARMword data)

     ARMul_State * state;
     // ARMul_State * state ATTRIBUTE_UNUSED; // TCM change for g++ compile
     ARMword address;
     ARMword data;
     */
{
