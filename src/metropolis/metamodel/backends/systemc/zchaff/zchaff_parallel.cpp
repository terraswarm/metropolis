...
void handle_result(int outcome, char * filename )
{
    ...
    case UNSATISFIABLE:
        ...
        break;
    case TIME_OUT:
        cout << "Time out, unable to determing the satisfiablility of the instance" << endl;
        break;
    case MEM_OUT:
        cout << "Memory out, unable to determing the satisfiablility of the instance" << endl;
        break;
    }
...
int main(int argc, char * * argv)
{
    ...
    if (argc < 3) {
        ...
        cerr << "Copyright 2001-2002, Princeton Univ." << endl << endl;;
